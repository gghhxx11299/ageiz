...
def dashboard(request: Request, session: dict = Depends(require_session)):
    ...
    translations = {
        ...
        "add_custom_source": get_translation("add_custom_source", user_language),
        "add_custom_source_modal": get_translation("add_custom_source_modal", user_language),
        "add_employee_btn": get_translation("add_employee_btn", user_language),
        "advanced_config": get_translation("advanced_config", user_language),
        "ageiz_intelligence": get_translation("ageiz_intelligence", user_language),
        "api_key_header_label": get_translation("api_key_header_label", user_language),
        "api_key_label": get_translation("api_key_label", user_language),
        "api_key_label_placeholder": get_translation("api_key_label_placeholder", user_language),
        "api_url_label": get_translation("api_url_label", user_language),
        ...
        "avg_overall": get_translation("avg_overall", user_language),
        ...
        "copied": get_translation("copied", user_language),
        "copy_link": get_translation("copy_link", user_language),
        "creating": get_translation("creating", user_language),
        "current_employees": get_translation("current_employees", user_language),
        "custom_headers_label": get_translation("custom_headers_label", user_language),
        "custom_intelligence_sources_title": get_translation("custom_intelligence_sources_title", user_language),
        "custom_sources_desc": get_translation("custom_sources_desc", user_language),
        "cycle_calibration": get_translation("cycle_calibration", user_language),
        "cycle_error": get_translation("cycle_error", user_language),
        "delete": get_translation("delete", user_language),
        "delete_custom_source_confirm": get_translation("delete_custom_source_confirm", user_language),
        "delete_embed_confirm": get_translation("delete_embed_confirm", user_language),
        "disconnect": get_translation("disconnect", user_language),
        "dismiss": get_translation("dismiss", user_language),
        "email_password_required": get_translation("email_password_required", user_language),
        "embed_feedback_desc": get_translation("embed_feedback_desc", user_language),
        "embed_feedback_title": get_translation("embed_feedback_title", user_language),
        "embed_label_placeholder": get_translation("embed_label_placeholder", user_language),
        "employee_email_placeholder": get_translation("employee_email_placeholder", user_language),
        "employee_management": get_translation("employee_management", user_language),
        "employee_management_desc": get_translation("employee_management_desc", user_language),
        ...
        "failed_load_custom_sources": get_translation("failed_load_custom_sources", user_language),
        "failed_load_staff": get_translation("failed_load_staff", user_language),
        "finalizing_cycle": get_translation("finalizing_cycle", user_language),
        "generate_code": get_translation("generate_code", user_language),
        "generate_link": get_translation("generate_link", user_language),
        "generating": get_translation("generating", user_language),
        "guest_feedback_desc": get_translation("guest_feedback_desc", user_language),
        "guest_feedback_submissions": get_translation("guest_feedback_submissions", user_language),
        ...
        "loading_reports": get_translation("loading_reports", user_language),
        "logout": get_translation("logout", user_language),
        ...
        "method_label": get_translation("method_label", user_language),
        "negative": get_translation("negative", user_language),
        "negative_label": get_translation("negative_label", user_language),
        "network_error": get_translation("network_error", user_language),
        "neural_confidence": get_translation("neural_confidence", user_language),
        "neural_cycle": get_translation("neural_cycle", user_language),
        ...
        "neutral": get_translation("neutral", user_language),
        "neutral_label": get_translation("neutral_label", user_language),
        "no_custom_sources": get_translation("no_custom_sources", user_language),
        "no_data_for_signal": get_translation("no_data_for_signal", user_language),
        "no_data_yet": get_translation("no_data_yet", user_language),
        "no_embed_links": get_translation("no_embed_links", user_language),
        "no_employees_yet": get_translation("no_employees_yet", user_language),
        "no_granular_asset": get_translation("no_granular_asset", user_language),
        "no_guest_feedback": get_translation("no_guest_feedback", user_language),
        "no_leaderboard": get_translation("no_leaderboard", user_language),
        "no_reports_staff": get_translation("no_reports_staff", user_language),
        ...
        "password_min_length": get_translation("password_min_length", user_language),
        "password_placeholder": get_translation("password_placeholder", user_language),
        "password_reset_success": get_translation("password_reset_success", user_language),
        "positive": get_translation("positive", user_language),
        "positive_label": get_translation("positive_label", user_language),
        ...
        "raw_data_not_available": get_translation("raw_data_not_available", user_language),
        "raw_telemetry_data": get_translation("raw_telemetry_data", user_language),
        "recommend": get_translation("recommend", user_language),
        "recommendation": get_translation("recommendation", user_language),
        "remove_employee": get_translation("remove_employee", user_language),
        "remove_employee_confirm": get_translation("remove_employee_confirm", user_language),
        "request_body_label": get_translation("request_body_label", user_language),
        "reset_password": get_translation("reset_password", user_language),
        "response_path_label": get_translation("response_path_label", user_language),
        "restoring_session": get_translation("restoring_session", user_language),
        "risk_profile": get_translation("risk_profile", user_language),
        "role_manager": get_translation("role_manager", user_language),
        "role_staff": get_translation("role_staff", user_language),
        "save_source_btn": get_translation("save_source_btn", user_language),
        "security_sessions": get_translation("security_sessions", user_language),
        "sentiment_distribution": get_translation("sentiment_distribution", user_language),
        "sentiment_radar": get_translation("sentiment_radar", user_language),
        "settings": get_translation("settings", user_language),
        "signal_error": get_translation("signal_error", user_language),
        "source_desc_label": get_translation("source_desc_label", user_language),
        "source_desc_placeholder": get_translation("source_desc_placeholder", user_language),
        "source_name_label": get_translation("source_name_label", user_language),
        "source_name_placeholder": get_translation("source_name_placeholder", user_language),
        "stable": get_translation("stable", user_language),
        "staff_intelligence": get_translation("staff_intelligence", user_language),
        "staff_intelligence_feed": get_translation("staff_intelligence_feed", user_language),
        "standard_inventory": get_translation("standard_inventory", user_language),
        "status_active": get_translation("status_active", user_language),
        "status_active_linked": get_translation("status_active_linked", user_language),
        "status_disabled": get_translation("status_disabled", user_language),
        "status_not_linked": get_translation("status_not_linked", user_language),
        "strategy_ai": get_translation("strategy_ai", user_language),
        "submissions": get_translation("submissions", user_language),
        ...
        "telegram_neural_link_popup": get_translation("telegram_neural_link_popup", user_language),
        ...
        "test_connection_btn": get_translation("test_connection_btn", user_language),
        "top_contributors": get_translation("top_contributors", user_language),
        "total_reports_label": get_translation("total_reports_label", user_language),
        ...
        "valid_for_5_mins": get_translation("valid_for_5_mins", user_language),
        "weekly_intelligence_trend": get_translation("weekly_intelligence_trend", user_language),
